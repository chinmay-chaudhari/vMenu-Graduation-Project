...
<ul class="tab">
  ...
  <li><a href="javascript:void(0)" class="tablinks" onclick="openClicked(event, 'displayBills')">Display Bills</a></li>
  <li><a href="javascript:void(0)" class="tablinks" onclick="openClicked(event, 'feedbackdisp')">Feedback</a></li>
...
<form style="visibility:hidden" id="uform" method="post" action="update_staff?id=add">
<table>
<tr>
...
<form style="visibility:hidden" id="dform" method="post" action="update_staff?id=delete">
<table>
<tr>
    <td align="right">Staff Name: </td><td align="left"><input type="text" name="staffname"></td>
</tr>
...
<form style="visibility:hidden" id="amform" method="post" action="update_menu?id=add">
<table>
<tr>
...
<form style="visibility:hidden" id="umform" method="post" action="update_menu?id=update">
<table>
<tr>
    <td align="right">Menu Name: </td><td align="left"><input type="text" name="menuname" ></td>
</tr>
...
<form style="visibility:hidden" id="dmform" method ="post" action="update_menu?id=delete">
<table>
<tr>
...
<div id="displayBills" class="tabcontent">
    <table border="1" align="center">
        <tr>
        <td align="center"><b>Bill. No.</b></td><td align="center"><b>Customer No.</b></td><td align="center"><b>Customer Name</b></td><td align="center"><b>Amount</b></td><td align="center"><b>Date</b></td><td align="center"><b>Status</b></td>
        </tr>
        <%
        ...
        %>
        <tr>
            <td align="center"><%= rs.getString("bill_no") %></td><td align="center"><%= rs.getString("c_id") %></td><td align="center"><%= rs.getString("c_name") %></td>
        <td align="center"><%= rs.getString("amount") %></td><td align="center"><%= rs.getString("date") %></td><td align="center"><%= rs.getString("status") %></td>
        </tr>
        <%
            }
        %>
...
<div id="feedbackdisp" class="tabcontent">
    <table border="1" align="center">
        <tr>
        <td align="center"><b>Feedback No.</b></td><td align="center"><b>Customer Name</b></td><td align="center"><b>Email ID</b></td><td align="center"><b>Feedback</b></td>
        </tr>
        <%
            rs=st.executeQuery("SELECT customer.c_name,feedback.f_id,feedback.c_id,feedback.email_id,feedback.f_desc FROM customer,feedback WHERE customer.c_id=feedback.c_id");
            i=1;
            while(rs.next()){
        %>
        <tr>
            <td align="center"><%= rs.getString("f_id") %></td><td align="center"><%= rs.getString("c_name") %></td><td align="center"><%= rs.getString("email_id") %></td>
        <td align="center"><%= rs.getString("f_desc") %></td>
        </tr>
        <%
            }
        %>
